...
class TeamMatchServiceImplTest {
    ...
    static final LocalDateTime MATCH_TIME = LocalDateTime.of(2030, 1, 1, 1, 1);
    static TeamMatchCreateRequest matchCreateRequest = new TeamMatchCreateRequest(MATCH_TIME, "stadium", "address");


    private List<TeamMatchGoalCreateRequest> createGoals(
            Long homeTeamId,
            Long homeScorerMemberId,
            int homeGoalCount,
            Long awayTeamId,
            Long awayScorerMemberId,
            int awayGoalCount
    ) {
        List<TeamMatchGoalCreateRequest> goals = new ArrayList<>();

        if (homeGoalCount > 0) {
            goals.add(new TeamMatchGoalCreateRequest(
                    homeTeamId,
                    homeScorerMemberId,
                    homeGoalCount
            ));
    ...
    void teamMatchCreate() throws Exception {
        ...
        // when
        TeamMatchCreateResponse response = teamMatchService.createTeamMatch(team.getTeamId(), member.getMemberId(), matchCreateRequest);
    ...
    void teamMatchCreate_notTeamLeader() throws Exception {
        ...
        // when && then
        assertThatThrownBy(() -> teamMatchService.createTeamMatch(team.getTeamId(), memberB.getMemberId(), matchCreateRequest))
    ...
    void teamMatchCreate_notExistTeam() throws Exception {
        ...
        // when && then
        assertThatThrownBy(() -> teamMatchService.createTeamMatch(9999L, member.getMemberId(),  matchCreateRequest))
    ...
    void teamMatchCreate_notExistMember() throws Exception {
        ...
        // when && then
        assertThatThrownBy(() -> teamMatchService.createTeamMatch(team.getTeamId(), 9999L,  matchCreateRequest))
    ...
    void teamMatchCreate_duplicateTeamMatch_pending() throws Exception {
        ...
        SignupResponse member = authService.signup("test", "1234");
        TeamCreateResponse team = teamService.createTeam("teamA", member.getMemberId());
        teamMatchService.createTeamMatch(team.getTeamId(), member.getMemberId(),  matchCreateRequest); // 매치 등록

        // when && then
        assertThatThrownBy(() -> teamMatchService.createTeamMatch(team.getTeamId(), member.getMemberId(),  matchCreateRequest))
    ...
    void teamMatchCreate_duplicateTeamMatch_matched() throws Exception {
        ...
        TeamMatchCreateResponse response = teamMatchService.createTeamMatch(team.getTeamId(), member.getMemberId(),  matchCreateRequest);// 매치 등록
        ...
        assertThatThrownBy(() -> teamMatchService.createTeamMatch(team2.getTeamId(), member2.getMemberId(), matchCreateRequest))
                .isInstanceOf(DuplicateTeamMatchException.class)
                .hasMessage("이미 진행중인 매치가 존재합니다.");
    }
    ...
    void findPendingMatches() throws Exception {
        ...
        TeamCreateResponse team = teamService.createTeam("teamA", member.getMemberId());
        TeamMatchCreateResponse teamMatch = teamMatchService.createTeamMatch(team.getTeamId(), member.getMemberId(),  matchCreateRequest);
    ...
    void findPendingMatches_noContainStatusIsMatched() throws Exception {
        ...
        Team bTeam = teamRepository.findById(teamB.getTeamId()).get();
    ...
    void findPendingMatches_orderByCreatedAtDesc() throws Exception {
        ...
        TeamMatchCreateResponse teamMatch = teamMatchService.createTeamMatch(team.getTeamId(), member.getMemberId(),  matchCreateRequest);
        TeamMatchCreateResponse teamMatchB = teamMatchService.createTeamMatch(teamB.getTeamId(), memberB.getMemberId(),  matchCreateRequest);
    ...
    void acceptTeamMatch() throws Exception {
        ...
        TeamMatchCreateResponse teamMatch = teamMatchService.createTeamMatch(team.getTeamId(), memberA.getMemberId(),  matchCreateRequest);
    ...
    void acceptTeamMatch_notExistTeamMatch() throws Exception {
        ...
        teamMatchService.createTeamMatch(team.getTeamId(), memberA.getMemberId(),  matchCreateRequest);
    ...
    void acceptTeamMatch_notTeamLeader() throws Exception {
        ...
        SignupResponse memberA = authService.signup("memberA", "1234");
        TeamCreateResponse team = teamService.createTeam("teamA", memberA.getMemberId());
        TeamMatchCreateResponse match = teamMatchService.createTeamMatch(team.getTeamId(), memberA.getMemberId(),  matchCreateRequest);
    ...
    void acceptTeamMatch_AlreadyExistTeamMatch() throws Exception {
        ...
        TeamMatchCreateResponse match = teamMatchService.createTeamMatch(teamA.getTeamId(), memberA.getMemberId(),  matchCreateRequest); // teamA -> 매치등록
        TeamMatchCreateResponse match2 = teamMatchService.createTeamMatch(teamB.getTeamId(), memberB.getMemberId(),  matchCreateRequest); // teamB -> 매칭등록.
    ...
    void findMatches() throws Exception {
        ...
        teamMatchService.createTeamMatch(teamA.getTeamId(), memberA.getMemberId(),  matchCreateRequest); // teamA -> 매치등록
        teamMatchService.createTeamMatch(teamB.getTeamId(), memberB.getMemberId(),  matchCreateRequest); // teamB -> 매칭등록.
    ...
    void findMatches_matched() throws Exception {
        ...
        TeamMatchCreateResponse teamMatch = teamMatchService.createTeamMatch(teamA.getTeamId(), memberA.getMemberId(),  matchCreateRequest);// teamA -> 매치등록
    ...
    void findMatches_completed() throws Exception {
        ...
        teamMatchService.registerMatchResult(
                teamMatch.getTeamMatchId(),
                memberA.getMemberId(),
                3,
                2,
                createGoals(teamA.getTeamId(), memberA.getMemberId(), 3,
                        teamB.getTeamId(), memberB.getMemberId(), 2)
        );
    ...
    void matchResult_home() throws Exception {
        ...
        TeamMatchCreateResponse teamMatch = teamMatchService.createTeamMatch(teamA.getTeamId(), memberA.getMemberId(),  matchCreateRequest);// teamA 매치 등록
        teamMatchService.acceptTeamMatch(teamMatch.getTeamMatchId(), memberB.getMemberId()); // teamB 가 수락

        // when
        TeamMatchResultResponse result = teamMatchService.registerMatchResult(
                teamMatch.getTeamMatchId(),
                memberA.getMemberId(),
                3,
                1,
                createGoals(teamA.getTeamId(), memberA.getMemberId(), 3,
                        teamB.getTeamId(), memberB.getMemberId(), 1)
        );
    ...
    void matchResult_away() throws Exception {
        ...
        TeamMatchResultResponse result = teamMatchService.registerMatchResult(
                ...
                5,
                createGoals(teamA.getTeamId(), memberA.getMemberId(), 3,
                        teamB.getTeamId(), memberB.getMemberId(), 5)
        );
        TeamMatch realTeamMatch = teamMatchRepository.findById(teamMatch.getTeamMatchId()).get();
    ...
    void matchResult_draw() throws Exception {
        ...
        TeamMatchResultResponse result = teamMatchService.registerMatchResult(
                ...
                3,
                createGoals(teamA.getTeamId(), memberA.getMemberId(), 3,
                        teamB.getTeamId(), memberB.getMemberId(), 3)
        );
        TeamMatch realTeamMatch = teamMatchRepository.findById(teamMatch.getTeamMatchId()).get();
    ...
    void matchResult_PENDING() throws Exception {
        ...
        // when && then
        assertThatThrownBy(() -> teamMatchService.registerMatchResult(
                teamMatch.getTeamMatchId(),
                memberA.getMemberId(),
                3,
                3,
    ...
    void matchResult_member() throws Exception {
        ...
        // when && then
        assertThatThrownBy(() -> teamMatchService.registerMatchResult(teamMatch.getTeamMatchId(), memberC.getMemberId(), 3, 3, List.of()))
                .isInstanceOf(NotTeamLeaderException.class)
                .hasMessage("팀장이 아닙니다.");
    }
    ...
    void matchResult_score_neagative() throws Exception {
        ...
        // when && then
        assertThatThrownBy(() -> teamMatchService.registerMatchResult(teamMatch.getTeamMatchId(), memberA.getMemberId(), -3, 1, List.of()))
    ...
    void matchResult_score_null() throws Exception {
        ...
        // when && then
        assertThatThrownBy(() -> teamMatchService.registerMatchResult(teamMatch.getTeamMatchId(), memberA.getMemberId(), null, 1, List.of()))
                .isInstanceOf(TeamMatchResultScoreException.class)
    ...
    void matchResult_otherTeam() throws Exception {
        ...
        // when && then
        assertThatThrownBy(() -> teamMatchService.registerMatchResult(teamMatch.getTeamMatchId(), memberC.getMemberId(), 3, 1, List.of()))
                .isInstanceOf(NotSameTeamException.class)
                .hasMessage("홈팀이 아닙니다.");
    }
    ...
    void matchResult_alreadyExistMatchResult() throws Exception {
        ...
        teamMatchService.registerMatchResult(
                ...
                createGoals(teamA.getTeamId(), memberA.getMemberId(), 3,
                        teamB.getTeamId(), memberB.getMemberId(), 3)
        ); // teamA 가 매치 결과 , goals등록

        // when && then
        assertThatThrownBy(() -> teamMatchService.registerMatchResult(teamMatch.getTeamMatchId(), memberA.getMemberId(), 5, 3, List.of()))
    ...
    void COMPLETED_MatchHistory() throws Exception {
        ...
        teamMatchService.registerMatchResult(
                ...
                3,
                1,
                createGoals(team.getTeamId(), memberA.getMemberId(), 3,
                        teamB.getTeamId(), memberB.getMemberId(), 1)
        );
    ...
    void already_exist_matchResult_rating() throws Exception {
        ...
        TeamCreateResponse team = teamService.createTeam("teamA", memberA.getMemberId());
        TeamCreateResponse teamB = teamService.createTeam("teamB", memberB.getMemberId());
        TeamMatchCreateResponse teamMatch = teamMatchService.createTeamMatch(team.getTeamId(), memberA.getMemberId(), matchCreateRequest); // 2026-1-1 01:01에 매치
        teamMatchService.acceptTeamMatch(teamMatch.getTeamMatchId(), memberB.getMemberId());
        ...
        assertThat(teamMatchEntity.getStatus()).isEqualTo(TeamMatchStatus.COMPLETED);
        assertThat(result.getWinnerTeamId()).isEqualTo(team.getTeamId());
        assertThat(teamMatch.getPlayedAt()).isEqualTo(matchCreateRequest.getPlayedAt());
        assertThat(teamMatch.getStadiumName()).isEqualTo("stadium");
        assertThat(teamMatch.getStadiumAddress()).isEqualTo("address");

        assertThat(teamMatchEntity.getPlayedAt()).isEqualTo(matchCreateRequest.getPlayedAt());
        assertThat(teamMatchEntity.getStadiumName()).isEqualTo("stadium");
        assertThat(teamMatchEntity.getStadiumAddress()).isEqualTo("address");
    }
    ...
    void matchDetail_pending() throws Exception {
        ...
        SignupResponse memberA = authService.signup("memberA", "1234");
        TeamCreateResponse team = teamService.createTeam("teamA", memberA.getMemberId());
        TeamMatchCreateResponse teamMatch = teamMatchService.createTeamMatch(team.getTeamId(), memberA.getMemberId(), matchCreateRequest);// 2026-1-1, 01:01 에 매치
        ...
        assertThat(response.getPlayedAt()).isEqualTo(matchCreateRequest.getPlayedAt());
